...
*/
extern bool ReadModulePathFromRegA(const HKEY hKeyRoot, const char * szSubKey, const char * szValueName, char * szModulePath, const unsigned int uSize);
extern bool ReadModulePathFromRegW(const HKEY hKeyRoot, const wchar_t * szSubKey, const wchar_t * szValueName, wchar_t * szModulePath, const unsigned int uSize);
